...
% Organisation equipe, methodologie, risques, plan de déploiement, jalons
% ==============================================================================
...
l'\textbf{ESGI}, chacun occupant un r\^ole sp\'ecifique qui refl\`été \`a
...
sur son p\'erim\`être tout en maintenant une vision d'ensemble partag\'ee
...
\begin{table}[h]
  ...
  \begin{tabular}{@{}llp{7cm}@{}}
    ...
    Chef de Projet / DevOps
      & Cl\'ery A.-Ferradou
      & Coordination \'equipe, CI/CD, Docker, monitoring,
        scripts d\'eploiement, gestion des risques \\
    D\'eveloppeur EDR
      & Swann Kechar
...
\textbf{Cl\'ery A.-Ferradou}~: Chef de Projet et DevOps, il assure la
coh\'erence de l'infrastructure. Son p\'erim\`être couvre
...
(\texttt{install.sh}, \texttt{backup.sh}). Il coordonne \'egalement
les sprints et la gestion des risques.

\textbf{Swann Kechar}~: D\'eveloppeur EDR, il travaille sur le c\^ocur
...
\subsection{Approche Agile adapt\'ee}

L'\'equipe a adopt\'e une m\'ethodologie Agile adapt\'ee au contexte
acad\'emique et \`a la taille r\'eduite de l'\'equipe. Le cadre de
travail s'inspire de \textbf{Scrum} sans en appliquer tous les
artefacts, afin de rester l\'eger et efficace.

Les \'el\'ements cl\'es de cette m\'ethodologie sont~:

\begin{itemize}
  \item \textbf{Sprints de deux semaines}~: chaque sprint produit un
    incr\'ement fonctionnel du produit. La dur\'ee de deux semaines
    offre un \'equilibre entre la charge de planification et la
    visibilit\'e sur l'avancement.
  \item \textbf{Daily standups trois fois par semaine}~: les lundis,
    mercredis et vendredis, l'\'equipe se retrouve pour un point de 15
    minutes sur l'avancement et les blocages \'eventuels. Ce rythme
    permet de maintenir une dynamique sans alourdir l'emploi du temps.
  \item \textbf{Sprint review en fin de sprint}~: \`a l'issue de chaque
    sprint, l'\'equipe pr\'esente les fonctionnalit\'es livr\'ees et
    recueille les retours.
  \item \textbf{R\'etrospective}~: la r\'etrospective conclut chaque
    sprint en identifiant les axes d'am\'elioration du fonctionnement
    de l'\'equipe.
  \item \textbf{Backlog g\'er\'e via GitHub Projects}~: les t\^aches
    sont prioris\'ees et suivies dans un tableau Kanban int\'egr\'e \`a
    GitHub, offrant une visibilit\'e partag\'ee sur l'avancement.
\end{itemize}

\subsection{Rituels}

Les rituels de l'\'equipe sont organis\'es selon un calendrier
pr\'evisible qui structure la vie du projet.

\begin{description}
  \item[Daily]~: point de 15 minutes, trois fois par semaine. Chaque
    membre r\'epond \`a trois questions~: qu'ai-je fait depuis le
    dernier daily~? que vais-je faire aujourd'hui~? quels sont mes
    blocages~?
  \item[Sprint planning]~: r\'eunion en d\'ebut de sprint pour
    d\'efinir les objectifs, s\'electionner les t\^aches du backlog et
    les affecter aux membres de l'\'equipe.
  \item[Sprint review]~: d\'emonstration des fonctionnalit\'es
    livr\'ees, suivie d'une discussion sur les \'ecarts \'eventuels
    entre les objectifs planifi\'es et le r\'ealis\'e.
  \item[R\'etrospective]~: moment d'\'echange sur le d\'eroulement du
    sprint, visant \`a am\'eliorer en continu les pratiques de
    l'\'equipe.
\end{description}
...
\begin{itemize}
  \item \textbf{GitHub}~: plateforme centrale du projet. Elle h\'eborge
  ...
  \item \textbf{Discord}~: outil de communication quotidienne pour les
    \'echanges rapides, le partage d'\'écran et l'organisation
    informelle.
  ...
  \item \textbf{Code review syst\'ematique}~: toute modification est
    ...
    avant d'\^être int\'egr\'ee. Cette pratique garantit la qualit\'e
...
\begin{enumerate}
  ...
  \item \textbf{Site client d\'eploy\'e} avec authentification, tableau
    de bord et gestion des abonn\'es.
...
condition r\'eelle et peut \^être d\'eploy\'ee par un client sans
