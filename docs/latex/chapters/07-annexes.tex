...
Le script \texttt{install.sh} centralise le déploiement et les mises à jour
...
curl -fsSL https://raw.githubusercontent.com/Lockbits-ESGI/main/main/install-agent.sh | \
  SERVER_URL=https://edr.example.com AUTH_TOKEN=token bash -s -- --mode docker
\end{lstlisting}
...
\begin{longtable}{lp{10cm}}
  ...
  \textbf{EDR}
  & Endpoint Detection \& Response~--~solution de détection et réponse sur
  les terminaux. \\
  ...
  \textbf{Watchtower}
  & Outil de mise à jour automatique des conteneurs Docker, surveillant
