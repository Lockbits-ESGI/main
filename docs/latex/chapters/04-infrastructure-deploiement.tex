% ==============================================================================
% Chapitre 4 : Infrastructure et Deploiement
% Docker, CI/CD, scripts, monitoring, securite
% ==============================================================================
...
\begin{itemize}
  \item \textbf{Réseau \texttt{frontend}}~: exposé sur l'hôte, il connecte le
    serveur EDR et le site web. Seuls ces deux services sont accessibles
    depuis l'extérieur via les ports publiés.
  \item \textbf{Réseau \texttt{backend}}~: réseau interne qui connecte le
...
\texttt{.github/workflows/build-and-push.yml}. Il se déclenche sur chaque push
sur les branches \texttt{main} et \texttt{develop}, ainsi que sur les pull
requests vers ces branches. Le pipeline se déroule en quatre étapes
principales~:
...
curl -fsSL https://raw.githubusercontent.com/Lockbits-ESGI/main/main/install-agent.sh | \\
  SERVER_URL=https://edr.example.com AUTH_TOKEN=token bash
\end{lstlisting}
