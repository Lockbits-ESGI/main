...
\begin{enumerate}
  ...
  \item \textbf{Configuration Dokploy automatisée}~: le déploiement sur
    Dokploy doit être simplifié par un script de configuration qui
    prépare l'environnement, les variables et les réseaux sans
...
\textbf{Revue de code systématique.} Chaque modification du code source
...
\textbf{Mise à jour des dépendances.} Les dépendances logicielles
...
\textbf{Documentation vivante.} La documentation technique doit évoluer
...
\textbf{Monitoring des performances.} Les métriques de performance
