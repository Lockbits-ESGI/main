...
% nécessaires à la compilation du dossier d'architecture.
% ==============================================================================
...
\usepackage{csquotes}                     % Citations françaises
...
\lstset{
  ...
  tabsize=2,
  captionpos=b,
  % Support des caractères français dans le code
...
\usepackage{float}                        % Placement précis des flottants
