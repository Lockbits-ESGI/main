...
% necessaires a la compilation du dossier d'architecture.
% ==============================================================================
...
\lstset{
  ...
  tabsize=2,
  captionpos=b,
  % Support des caracteres francais dans le code
...
\hypersetup{
  ...
  pdfkeywords={EDR, Docker, FastAPI, PHP, Monitoring, CI/CD, Securite},
  pdfcreator={LaTeX},
